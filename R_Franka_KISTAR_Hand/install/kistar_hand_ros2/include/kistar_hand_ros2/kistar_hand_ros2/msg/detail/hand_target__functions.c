...
kistar_hand_ros2__msg__HandTarget__are_equal(const kistar_hand_ros2__msg__HandTarget * lhs, const kistar_hand_ros2__msg__HandTarget * rhs)
{
  ...
  // movement_duration
  if (lhs->movement_duration != rhs->movement_duration) {
    return false;
  }
  // hand_id
  ...
  kistar_hand_ros2__msg__HandTarget * output)
{
  ...
  // movement_duration
  output->movement_duration = input->movement_duration;
  // hand_id
...
kistar_hand_ros2__msg__HandTarget__create()
{
  ...
  kistar_hand_ros2__msg__HandTarget * msg = (kistar_hand_ros2__msg__HandTarget *)allocator.allocate(sizeof(kistar_hand_ros2__msg__HandTarget), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(kistar_hand_ros2__msg__HandTarget));
  bool success = kistar_hand_ros2__msg__HandTarget__init(msg);
  if (!success) {
...
kistar_hand_ros2__msg__HandTarget__destroy(kistar_hand_ros2__msg__HandTarget * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    kistar_hand_ros2__msg__HandTarget__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
kistar_hand_ros2__msg__HandTarget__Sequence__init(kistar_hand_ros2__msg__HandTarget__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  kistar_hand_ros2__msg__HandTarget * data = NULL;

  if (size) {
    data = (kistar_hand_ros2__msg__HandTarget *)allocator.zero_allocate(size, sizeof(kistar_hand_ros2__msg__HandTarget), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = kistar_hand_ros2__msg__HandTarget__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        kistar_hand_ros2__msg__HandTarget__fini(&data[i - 1]);
      }
...
kistar_hand_ros2__msg__HandTarget__Sequence__fini(kistar_hand_ros2__msg__HandTarget__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      kistar_hand_ros2__msg__HandTarget__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  kistar_hand_ros2__msg__HandTarget__Sequence * array = (kistar_hand_ros2__msg__HandTarget__Sequence *)allocator.allocate(sizeof(kistar_hand_ros2__msg__HandTarget__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = kistar_hand_ros2__msg__HandTarget__Sequence__init(array, size);
  if (!success) {
...
kistar_hand_ros2__msg__HandTarget__Sequence__destroy(kistar_hand_ros2__msg__HandTarget__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    kistar_hand_ros2__msg__HandTarget__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
kistar_hand_ros2__msg__HandTarget__Sequence__are_equal(const kistar_hand_ros2__msg__HandTarget__Sequence * lhs, const kistar_hand_ros2__msg__HandTarget__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!kistar_hand_ros2__msg__HandTarget__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  kistar_hand_ros2__msg__HandTarget__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(kistar_hand_ros2__msg__HandTarget);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    kistar_hand_ros2__msg__HandTarget * data =
      (kistar_hand_ros2__msg__HandTarget *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!kistar_hand_ros2__msg__HandTarget__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          kistar_hand_ros2__msg__HandTarget__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!kistar_hand_ros2__msg__HandTarget__copy(
